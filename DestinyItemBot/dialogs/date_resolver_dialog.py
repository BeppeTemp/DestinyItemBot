...
class DateResolverDialog(CancelAndHelpDialog):
    def __init__(self, dialog_id: str = None):
        ...
        self.add_dialog(WaterfallDialog(WaterfallDialog.__name__ + "2", [self.initial_step, self.final_step]))
    ...
    async def initial_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        if timex is None:
            ...
            return await step_context.prompt(DateTimePrompt.__name__,PromptOptions(prompt=prompt_msg, retry_prompt=reprompt_msg),)
