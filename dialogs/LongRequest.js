const { ActivityTypes, CardFactory, BotFrameworkAdapter } = require('botbuilder');
        ...
        try {
            ...
            await adapter.continueConversation(conversationReference, async turnContext => {
                if (mod.error == 0) {
                    ...
                    await turnContext.sendActivity("Codice di accesso scaduto.");
                    await br.loginStep(turnContext);
                }
            });
        } catch (error) {
