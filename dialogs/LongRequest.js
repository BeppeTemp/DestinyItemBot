        ...
        try {
            ...
            await adapter.continueConversation(conversationReference, async turnContext => {
                if(status.error == 0){
                    ...
                    await turnContext.sendActivity("❌ Il trasferimento che avevi richiesto è fallito. Assicurati di aver richiesto il trasferimento di un item non equipaggiato e che il pg di destinazione abbia slot liberi nell'inventario, se il problema persiste contatta uno sviluppatore.");
                } 
