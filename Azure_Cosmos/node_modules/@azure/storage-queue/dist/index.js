...
var QueueClient = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.queueContext.create(tslib.__assign(tslib.__assign({}, options), { abortSignal: options.abortSignal, spanOptions: spanOptions }))];
    ...
    QueueClient.prototype.createIfNotExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, response, e_2;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("QueueClient-createIfNotExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                    ...
                    case 2:
                        ...
                        if (response._response.status == 204) {
                            return [2 /*return*/, tslib.__assign({ succeeded: false }, response)];
                        }
                        return [2 /*return*/, tslib.__assign({ succeeded: true }, response)];
                    case 3:
                        e_2 = _d.sent();
    ...
    QueueClient.prototype.deleteIfExists = function (options) {
        ...
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _c, span, spanOptions, res, e_3;
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _c = createSpan("QueueClient-deleteIfExists", options.tracingOptions), span = _c.span, spanOptions = _c.spanOptions;
                        _d.label = 1;
                    case 1:
                        _d.trys.push([1, 3, 4, 5]);
                    ...
                    case 3:
                        ...
                        if (((_a = e_3.details) === null || _a === void 0 ? void 0 : _a.errorCode) === "QueueNotFound") {
                            ...
                            return [2 /*return*/, tslib.__assign(tslib.__assign({ succeeded: false }, (_b = e_3.response) === null || _b === void 0 ? void 0 : _b.parsedHeaders), { _response: e_3.response })];
                        }
                        span.setStatus({
                            code: api.CanonicalCode.UNKNOWN,
                            message: e_3.message
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.queueContext.deleteMethod({
    ...
    QueueClient.prototype.exists = function (options) {
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = createSpan("QueueClient-exists", options.tracingOptions), span = _a.span, spanOptions = _a.spanOptions;
                        _b.label = 1;
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
    ...
    QueueClient.prototype.getAccessPolicy = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, res, _i, response_1, identifier, accessPolicy, e_8;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    QueueClient.prototype.setAccessPolicy = function (queueAcl, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, acl, _i, _b, identifier, e_9;
    ...
    QueueClient.prototype.sendMessage = function (messageText, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, item, e_11;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    QueueClient.prototype.receiveMessages = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, res, _i, response_2, item, e_12;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    QueueClient.prototype.peekMessages = function (options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, response, res, _i, response_3, item, e_13;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.getMessageIdContext(messageId).deleteMethod(popReceipt, {
                                abortSignal: options.abortSignal,
                                spanOptions: spanOptions
                            })];
                    case 2: return [2 /*return*/, _b.sent()];
    ...
    QueueClient.prototype.updateMessage = function (messageId, popReceipt, message, visibilityTimeout, options) {
        if (options === void 0) { options = {}; }
        return tslib.__awaiter(this, void 0, void 0, function () {
            var _a, span, spanOptions, queueMessage, e_15;
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    QueueClient.prototype.generateSasUrl = function (options) {
        ...
        var sas = generateQueueSASQueryParameters(tslib.__assign({ queueName: this.name }, options), this.credential).toString();
...
var QueueServiceClient = /** @class */ (function (_super) {
            ...
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1: return [4 /*yield*/, tslib.__await(this.listQueuesSegment(marker, options))];
                    case 2:
            ...
            return tslib.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        segment = _b.value;
                        if (!segment.queueItems) return [3 /*break*/, 6];
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.getQueueClient(queueName).create(tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_6 = _b.sent();
                        span.setStatus({
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, 4, 5]);
                        return [4 /*yield*/, this.getQueueClient(queueName).delete(tslib.__assign(tslib.__assign({}, options), { tracingOptions: tslib.__assign(tslib.__assign({}, options.tracingOptions), { spanOptions: spanOptions }) }))];
                    case 2: return [2 /*return*/, _b.sent()];
                    case 3:
                        e_7 = _b.sent();
                        span.setStatus({
     ...
     * @memberof QueueServiceClient
     */
    QueueServiceClient.prototype.generateAccountSasUrl = function (expiresOn, permissions, resourceTypes, options) {
        ...
        var sas = generateAccountSASQueryParameters(tslib.__assign({ permissions: permissions,
            expiresOn: expiresOn,
            resourceTypes: resourceTypes, services: AccountSASServices.parse("q").toString() }, options), this.credential).toString();
        return appendToURLQuery(this.url, sas);
    };
